...
class CorefModel(object):
  def __init__(self, config):
    ...
    # successfully gets here?
    print("Just finished loading embedding dictionaries while creating CorefModel")
    ...
    print("Loaded h5py file and some other stuff")
    ...
    print("Just finished some stuff with input_props * what are input_props")

    print("Going to queue some input tensors...")
    ...
    print("Going to get some predictions and loss?")
