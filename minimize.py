...
def handle_line(line, document_state, language, labels, stats):
  # print(conll.BEGIN_DOCUMENT_REGEX)
...
def minimize_language(language, labels, stats):
  ...
  # new
  minimize_partition("dev", language, "conll", labels, stats)
  minimize_partition("train", language, "conll", labels, stats)
  minimize_partition("test", language, "conll", labels, stats)
